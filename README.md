...
├── notebooks/
│   └── ResNet50_DenseNet121_CalTech101.ipynb     # Main training & analysis notebook
├── src/
│   ├── models.py                                 # Model loading and modification
│   ├── dataset.py                                # Custom dataset & transforms
│   ├── adaptive_ft.py                            # Adaptive Fine-Tuning implementation
...
SettingValueRuntimeGoogle Colab (T4 / A100)Precisionfloat32 / Mixed PrecisionDatasetCalTech-101 (~9.1K images)Training Time~15–60 minutes per runPeak GPU Memory~4–6 GB

Acknowledgments

CalTech-101 Dataset — California Institute of Technology
PyTorch & TorchVision — Pretrained models and utilities
ImageNet — Source of transferred knowledge
